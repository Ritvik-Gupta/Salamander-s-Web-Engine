...
These are mainly due to CORS policy on certain sites ( such as [Youtube](https://www.youtube.com/) )
that deny **CORS 'Access-Control-Allow-Origin'** on local servers. There may also be errors related
to **Cookies**. But these errors do not affect the actual _Process_ and can be overlooked.
